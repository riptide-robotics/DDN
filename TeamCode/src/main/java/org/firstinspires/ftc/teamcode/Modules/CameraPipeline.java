...
public class CameraPipeline implements VisionProcessor {
    ...
    @Override
    public void init(int a, int b, CameraCalibration c) {

    }

    public CameraPipeline(double tagsize, double fx, double fy, double cx, double cy, WebcamName camera) {

    }

    @Override
    public Object processFrame(Mat input, long captureTimeNanoseconds) {
        ...
        if (!contours.isEmpty() && largestArea != 0)
        {
            // Adding Text3
            Imgproc.putText (
